...
def surface(seed: int = 5):
    rng = np.random.default_rng(seed)
    spec = {"ASSD (mm)": {"nnUNet": (1.8, .5), "Cascade UNet": (1.4, .4), "CNISP": (.9, .25), "Proposed": (.6, .18), "Oracle": (.4, .12)},
            "HD95 (mm)": {"nnUNet": (6, 1.6), "Cascade UNet": (5, 1.4), "CNISP": (3, .9), "Proposed": (2, .6), "Oracle": (1.4, .4)},
            "Surface Dice @1mm": {"nnUNet": (.62, .08), "Cascade UNet": (.70, .07), "CNISP": (.85, .05), "Proposed": (.92, .03), "Oracle": (.96, .02)}}
