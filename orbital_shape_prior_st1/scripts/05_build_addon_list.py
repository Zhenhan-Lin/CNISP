#!/usr/bin/env python3
"""
Step 5: Build the "addon" training list (manifest) for CNISP.
...
Feed the manifest to scripts/06_add_training_data.py.

Usage:
    python scripts/05_build_addon_list.py -p configs/paths.yaml \
...
def main():
    ...
    print(f"  python scripts/06_add_training_data.py -p configs/paths.yaml "
          f"--manifest {out}")
