#!/usr/bin/env python3
"""
Step 01.2: Align the addon list and append the new cases to train_cases.txt.
...
scripts/011_build_addon_list.py, writing them into the SAME aligned_dir/labels +
